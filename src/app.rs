...
impl eframe::App for YssvApp {
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        // Titlebar — 30px, bg-titlebar, border-bottom
            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal_centered(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ...
                        // Theme toggle
                        let theme_icon = if self.settings.theme == theme::Theme::Dark {
                            "☀"
                        } else {
                            "🌙"
                        };
        ...
        if is_connections {
            ...
            egui::CentralPanel::default()
                ...
                .show(ctx, |ui| {
                    crate::pages::connections::render_detail(ui, self, ctx)
                });
        } else {
            ...
            egui::Panel::left("explorer_sidebar")
                ...
                .show(ctx, |ui| {
                    crate::pages::explorer::render_sidebar(ui, self, ctx)
                });
            egui::CentralPanel::default()
